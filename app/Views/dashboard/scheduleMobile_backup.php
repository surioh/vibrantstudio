...
<body>
    <div class="mobile-wrapper">
        ...
        <div class="class-button">
            <button type="button">Reformer / Half Tower</button>
            <button type="button">Wunda</button>
            <button type="button">Cadillac</button>
        </div>
        ...
        fetch(`/booking_list?tanggal=${encodeURIComponent(date)}`)
            ...
            .then(data => {
                ...
                const filteredData = data.filter(item => 
                    item.nama_kelas === selectedClass || 
                    (selectedClass === 'Reformer' && item.class_name_override === 'Half-Tower') // Include Half-Tower under Reformer
                );
